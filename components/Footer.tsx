      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-ryllBlack rounded-[2.5rem] p-8 md:p-12 flex flex-col justify-between min-h-[500px] relative overflow-hidden group">
           ...
           <div className="flex flex-col sm:flex-row gap-4 relative z-10">
              <button className="flex-1 px-8 py-4 bg-white text-ryllBlack rounded-2xl font-bold text-sm hover:bg-stone-200 transition-colors flex items-center justify-center gap-2 shadow-lg">
                Download Now
              </button>
              <button className="flex-1 px-8 py-4 bg-white/10 text-white border border-white/10 rounded-2xl font-bold text-sm hover:bg-white/20 transition-colors flex items-center justify-center gap-2 backdrop-blur-sm">
                Akses Web App
              </button>
           </div>
        </div>

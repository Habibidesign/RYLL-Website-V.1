              ...
              <div className="relative w-full max-w-sm lg:max-w-md z-10 flex flex-col gap-6 px-6">
                  ...
                  >
                    ...
                    <div className="flex gap-2 flex-wrap mb-8">
                        <span className="bg-stone-50 border border-stone-100 px-4 py-2 rounded-xl text-sm font-bold text-stone-600 hover:bg-stone-100 cursor-pointer transition-colors">Deep Talk</span>
                        <span className="bg-stone-50 border border-stone-100 px-4 py-2 rounded-xl text-sm font-bold text-stone-600 hover:bg-stone-100 cursor-pointer transition-colors">Spicy</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button className="bg-ryllOrange text-white px-6 py-3 rounded-xl font-bold hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30 text-sm flex items-center gap-2">

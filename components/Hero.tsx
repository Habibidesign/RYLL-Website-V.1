        ...
        <div className="flex flex-col justify-center px-6 md:px-12 lg:px-20 xl:px-24 pt-32 lg:pt-20 pb-12 lg:min-h-screen relative z-10 order-1 lg:order-1">
          ...
          >
            ...
            <div className="flex flex-row items-center gap-3 sm:gap-4 mb-8">
              <button className="flex-1 sm:flex-initial px-6 sm:px-8 py-3.5 sm:py-4 bg-ryllOrange text-white rounded-full font-bold text-base sm:text-lg shadow-xl shadow-orange-500/20 hover:scale-105 transition-transform flex items-center justify-center gap-2 whitespace-nowrap">
                Mulai Main <ArrowRight size={18} className="hidden sm:inline" />
              </button>
              <button className="flex-1 sm:flex-initial px-5 sm:px-6 py-3.5 sm:py-4 text-ryllBlack font-bold text-base sm:text-lg hover:bg-stone-100 rounded-full transition-colors whitespace-nowrap">
                Lihat Demo
              </button>
            </div>
            ...
            <div className="relative w-full max-w-sm lg:max-w-md z-10 flex flex-col gap-6 px-6">
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  {/* Changed Button Color to Orange & rounded-full */}
